...
SHIFTS = [
  ...
  {:shiftstart => DateTime.strptime("03/30/2015 10:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("03/30/2015 18:00", "%m/%d/%Y %H:%M")},
  {:shiftstart => DateTime.strptime("03/30/2015 10:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("03/30/2015 18:00", "%m/%d/%Y %H:%M")},
  {:shiftstart => DateTime.strptime("03/30/2015 14:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("03/30/2015 22:00", "%m/%d/%Y %H:%M")},
  {:shiftstart => DateTime.strptime("03/30/2015 18:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("03/30/2015 22:00", "%m/%d/%Y %H:%M")},
  {:shiftstart => DateTime.strptime("03/30/2015 18:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("03/30/2015 22:00", "%m/%d/%Y %H:%M")},
  ...
  {:shiftstart => DateTime.strptime("04/04/2015 11:00", "%m/%d/%Y %H:%M"),
   :shiftend => DateTime.strptime("04/04/2015 19:00", "%m/%d/%Y %H:%M")},
